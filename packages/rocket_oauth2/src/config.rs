...
providers! {
    ...
    Hogbisz: "https://auth.hogbisz.com/auth/realms/master/protocol/openid-connect/auth", "https://auth.hogbisz.com/auth/realms/master/protocol/openid-connect/token",
}
