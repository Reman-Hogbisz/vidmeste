<template>
    <!--write a 404 Page with current url-->
    <div
        class="flex flex-col items-center justify-center w-screen h-screen font-bold bg-rh-blue">
        <h1 class="mb-5 text-[8rem] text-rh-white">404</h1>
        <button
            v-on:click="gotoURL('/')"
            type="button"
